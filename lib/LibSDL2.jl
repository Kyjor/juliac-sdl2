...
Base.@ccallable function test1()::Cint
    println(Core.stdout, "Hello, 1111")
    x::Cdouble = 1.1
    println(Core.stdout, "Hello, $(ccall((:SDL_ceil, libsdl2), Cdouble, (Cdouble,), x))")
    ccall((:SDL_Init, libsdl2), Cint, (Uint32,), Cuint(0x00000020))
    # string::String = "str"
    # println(Core.stdout, "Hello, $(str)")
    #c_string::Cstring = Cstring("str")
...
Base.@ccallable function test()::Cint
    println(Core.stdout, "Hello, OOOT")
    x::Cdouble = 1.1
    println(Core.stdout, "Hello, $(ccall((:SDL_ceil, libsdl2), Cdouble, (Cdouble,), x))")
    # flags::Uint32 = SDL_INIT_VIDEO
    # ccall((:SDL_Init, libsdl2), Cint, (Uint32,), flags)
    # flags::Uint32 = Cuint(0x00000020)
    # ccall((:SDL_Init, libsdl2), Cint, (Uint32,), flags)
    # println(Core.stdout, "Hello, 1")
    #str = pointer(reinterpret(Cchar, 0))
    # xx = Cint(0)
    # y = Cint(0) 
    # flags = Uint32(4)
    #println(Core.stdout, "Hello, $(reinterpret(Cstring, 0))")
    # str = "Hello, World!"
    # #c_string = Cstring(str)
    # #ptr = pointer(str)
    # #title::Ptr{Cchar} = "windowTitle"
    # println(Core.stdout, "Hello, 2")
    #ex::Cint = Cint(0)
    ex =
    #println(Core.stdout, "Hello, $(ex)")
    # y::Cint = Cint(0)
    # println(Core.stdout, "Hello, $(y)")
    # w::Cint = 800
    # println(Core.stdout, "Hello, $(w)")
    # h::Cint = 600
    # println(Core.stdout, "Hello, $(h)")
    # wflags::Uint32 = Uint32(4)
    # println(Core.stdout, "Hello, $(wflags)")
    # GC.@preserve str begin
    #     ptr::Ptr{Cchar} = pointer(str)
    println(Core.stdout, "SDL Init: $(ccall((:SDL_Init, libsdl2), Cint, (Uint32,), Cuint(0x00000020)))")
    #ccall((:SDL_CreateWindow, libsdl2), Ptr{SDL_Window}, (Ptr{Cchar}, Cint, Cint, Cint, Cint, Uint32), pointer(reinterpret(Cstring, 0)), Cint(0), Cint(0), Cint(800), Cint(600), Uint32(4))
    # end
    return 0
end
